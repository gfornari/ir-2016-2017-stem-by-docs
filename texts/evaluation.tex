...
Using the Italian corpus (Table \ref{tab:itEval}), the situation is more complex. MAP increases using Snowball, but decreases using SNS. Prec@10 increases using a stemmer, in particular using Snowball. R-Prec decreases using both Snowball and SNS. Lastly, the number of relevant documents retrieved increases using Snowball, but decreases using SNS.
